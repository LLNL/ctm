...
#   timestamp: 2024-04-09T19:00:55+00:00
...
class Gen(BaseModel):
    ...
    reserve_provision: Optional[List[Dict[str, Any]]] = None
    source_uid: Optional[Any] = Field(
        None,
...
class CommonTransmissionModelCtmSolutionSchema(BaseModel):
